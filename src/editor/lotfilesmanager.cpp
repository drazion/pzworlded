...
//            return false;
    ...
    roomRectLookup.clear(0, 0, CHUNKS_PER_CELL, CHUNKS_PER_CELL, CHUNK_WIDTH);
...
bool LotFilesManager::generateHeader(WorldCell *cell, MapComposite *mapComposite)
{
    ...
    for (int level : mRoomRectByLevel.keys()) {
        ...
        mRoomRectLookup.clear(0, 0, CHUNKS_PER_CELL, CHUNKS_PER_CELL, CHUNK_WIDTH);
    ...
    mRoomLookup.clear(0, 0, CHUNKS_PER_CELL, CHUNKS_PER_CELL, CHUNK_WIDTH);
